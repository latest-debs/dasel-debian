...
[![Release](https://img.shields.io/github/v/release/latest-debs/dasel-debian)](https://github.com/latest-debs/dasel-debian/releases)
[![Build](https://github.com/latest-debs/dasel-debian/actions/workflows/release.yml/badge.svg)](../../actions)

[dasel](https://github.com/TomWright/dasel) — query and modify data structures using selector strings — packaged for
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/dasel-debian/releases) page:

```sh
sudo apt install ./dasel_*.deb
```

## Verify

```sh
apt-cache policy dasel
dasel --version
```
...
Run the [Build dasel for Debian](../../actions) workflow on GitHub with the
...
For issues with dasel itself, see
[dasel](https://github.com/TomWright/dasel).

## License

Packaging scripts in this repo are MIT-licensed. The packaged binaries
remain under their upstream license — see [dasel](https://github.com/TomWright/dasel).
